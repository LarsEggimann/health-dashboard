...
interface AuthContextType {
  ...
  login: (data: BodyAuthLoginAccessToken, redirectFn?: CallableFunction) => Promise<void>;
  logout: () => void;
  error: string | null;
  resetError: () => void;
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const loginFn = async (data: BodyAuthLoginAccessToken, redirectFn?: CallableFunction) => {
  ...
  const loginMutation = useMutation({
    mutationFn: (args: { data: BodyAuthLoginAccessToken, redirectFn?: CallableFunction}) => 
